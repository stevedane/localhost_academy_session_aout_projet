...
<div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper ps-container ps-theme-default ps-active-y" data-ps-id="6b1e2aab-20f6-7c64-8142-b09592d43025">
        <div class="user">
          <div class="photo">
      ...
      <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 544px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 385px;"></div></div></div>
    <div class="sidebar-background" style="background-image: url(../../assets/img/sidebar-1.jpg) "></div></div>
    <div class="main-panel ps-container ps-theme-default ps-active-y" data-ps-id="2fdbf859-926b-6627-c440-5896ceada380">
      <!-- Navbar -->
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            </script>2023, made with <i class="material-icons">favorite</i> by
            <a href="https://www.creative-tim.com" target="_blank">Creative Tim</a> for a better web.
          </div>
        </div>
      </footer>
    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: -594px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 594px; right: 0px; height: 532px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 177px; height: 159px;"></div></div></div>
  </div>
@endsection
