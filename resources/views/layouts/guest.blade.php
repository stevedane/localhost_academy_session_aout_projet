...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{asset('material-dashboard/assets')}}/img/login.jpg'); background-size: cover; background-position: top center;">
  ...
  <script src="{{asset('material-dashboard/assets')}}/js/material-dashboard.min.js?v=2.1.0" type="text/javascript"></script>
  <script>
  ...
  <!-- Sharrre libray -->
  <script src="{{asset('material-dashboard/assets')}}/demo/jquery.sharrre.js"></script>
  <script>
    $(document).ready(function() {
