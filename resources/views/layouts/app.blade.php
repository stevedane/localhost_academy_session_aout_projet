...
<body class="">
    <div class="wrapper ">
        <div class="sidebar" data-color="rose" data-background-color="black"
            data-image="{{ asset('material-dashboard') }}/assets/img/sidebar-1.jpg">
            <!--
    ...
    <script src="{{ asset('material-dashboard') }}/assets/js/material-dashboard.min.js?v=2.1.0" type="text/javascript">
    </script>
    <script>
